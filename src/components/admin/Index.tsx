      ...
      <main className={classes.content}>
        {loading ? (
          ...
          <Routes>
            ...
            <Route
              path="/products"
              element={<AdminRoute path="/" element={<Products />} />}
            />
            <Route
              path="/products/import"
              element={<AdminRoute path="/" element={<ImportProducts />} />}
            />
            <Route
              path="/products/update"
              element={<AdminRoute path="/" element={<UpdateProducts />} />}
            />
            <Route
              path="/orders"
              element={<AdminRoute path="/" element={<Orders />} />}
            />
            <Route
              path="/orders/edit/:id"
              element={<AdminRoute path="/" element={<EditOrder />} />}
            />
            <Route
              path="/orders/create"
              element={<AdminRoute path="/" element={<EditOrder />} />}
            ...
            <Route
              ...
              element={<AdminRoute path="/" element={<WholesaleOrders />} />}
            />
            <Route
              path="/members"
              element={<AdminRoute path="/" element={<Members />} />}
            />
            <Route
              path="/members/:id"
              element={<AdminRoute path="/" element={<EditMember />} />}
            />
            <Route
              path="/storecredits"
            ...
            <Route
              index
              element={<AdminRoute path="/" element={<Dashboard />} />}
            />
          </Routes>
        )}
      </main>
