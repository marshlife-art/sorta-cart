...
export interface paths {
  ...
  '/squareimport': {
    get: {
      parameters: {
        query: {
          id?: parameters['rowFilter.squareimport.id']
          created_at?: parameters['rowFilter.squareimport.created_at']
          api_key?: parameters['rowFilter.squareimport.api_key']
          status?: parameters['rowFilter.squareimport.status']
          products?: parameters['rowFilter.squareimport.products']
          name?: parameters['rowFilter.squareimport.name']
          notes?: parameters['rowFilter.squareimport.notes']
          /** Filtering Columns */
          select?: parameters['select']
          /** Ordering */
          order?: parameters['order']
      ...
      responses: {
        /** OK */
        200: {
          schema: definitions['squareimport'][]
        }
        /** Partial Content */
        206: unknown
      }
    ...
    post: {
      parameters: {
        body: {
          /** squareimport */
          squareimport?: definitions['squareimport']
        }
        query: {
          /** Filtering Columns */
          select?: parameters['select']
...
export interface definitions {
  ...
  /** @description square product imports */
  squareimport: {
    /**
     * Format: bigint
     * @description Note:
...
export interface parameters {
  ...
  /** @description squareimport */
  'body.squareimport': definitions['squareimport']
  /** Format: bigint */
  'rowFilter.squareimport.id': string
  /** Format: timestamp with time zone */
  'rowFilter.squareimport.created_at': string
  /** Format: uuid */
  'rowFilter.squareimport.api_key': string
  /** Format: text */
  'rowFilter.squareimport.status': string
  /** Format: jsonb */
  'rowFilter.squareimport.products': string
  /** Format: text */
  'rowFilter.squareimport.name': string
  /** Format: text */
  'rowFilter.squareimport.notes': string
  /** @description stock */
